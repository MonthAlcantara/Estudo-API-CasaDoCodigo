...
public class NovoLivroForm {
    ...
    private String isbn;
    @NotNull
    private MultipartFile capa; // MultipartFile é a abstração do Spring MVC para receber upload
    @NotNull
    ...
    public Livro novoLivro(AutorRepository autorRepository, Uploader uploader) {
        ...
        return new Livro(titulo, subTitulo, preco, conteudo,
                sumario, numeroPaginas, isbn, linkCapaLivro, autor);
    }
}
